    ...
    override fun onCreate(savedInstanceState : Bundle?) {
        ...
        textColorButton?.setOnClickListener {
            ColorPicker(activity).apply {
                ...
                setColors(Color.GRAY, Color.argb(180, 0, 0, 0), Color.argb(180, 255, 255, 255), Color.argb(180, 229, 56, 33), Color.argb(180, 67, 160, 71), Color.argb(180, 3, 155, 229))
        ...
        backgroundColorButton?.setOnClickListener {
            ColorPicker(activity).apply {
                ...
                setRoundColorButton(true)
                setColors(Color.TRANSPARENT, Color.GRAY, Color.argb(180, 0, 0, 0), Color.argb(180, 255, 255, 255), Color.argb(180, 229, 56, 33), Color.argb(180, 67, 160, 71), Color.argb(180, 3, 155, 229))
